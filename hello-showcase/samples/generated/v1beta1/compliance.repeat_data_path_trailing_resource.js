...
function main() {
  ...
  async function callRepeatDataPathTrailingResource() {
    // Construct request
    const request = {
    };

    // Run request
    const response = await showcaseClient.repeatDataPathTrailingResource(request);
    console.log(response);
  }

  callRepeatDataPathTrailingResource();
