...
function main() {
  // [START localhost_v1beta1_generated_Compliance_RepeatDataSimplePath_async]
  /**
  ...
  async function callRepeatDataSimplePath() {
    // Construct request
    const request = {
    };

    // Run request
    const response = await showcaseClient.repeatDataSimplePath(request);
    console.log(response);
  }

  callRepeatDataSimplePath();
  // [END localhost_v1beta1_generated_Compliance_RepeatDataSimplePath_async]
}
