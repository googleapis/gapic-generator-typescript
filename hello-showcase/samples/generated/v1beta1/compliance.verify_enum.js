...
function main() {
  // [START localhost_v1beta1_generated_Compliance_VerifyEnum_async]
  /**
  ...
  async function callVerifyEnum() {
    // Construct request
    const request = {
    };

    // Run request
    const response = await showcaseClient.verifyEnum(request);
    console.log(response);
  }

  callVerifyEnum();
  // [END localhost_v1beta1_generated_Compliance_VerifyEnum_async]
}
