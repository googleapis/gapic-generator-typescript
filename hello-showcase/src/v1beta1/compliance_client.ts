 ...
 */
import * as gapicConfig from './compliance_client_config.json';
...
export class ComplianceClient {
  ...
  /**
   * Construct an instance of ComplianceClient.
   *
  ...
  initialize() {
    ...
    if (this.complianceStub) {
      return this.complianceStub;
    }

    // Put together the "service stub" for
    // google.showcase.v1beta1.Compliance.
    this.complianceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.showcase.v1beta1.Compliance') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.showcase.v1beta1.Compliance,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const complianceStubMethods =
        ['repeatDataBody', 'repeatDataBodyInfo', 'repeatDataQuery', 'repeatDataSimplePath', 'repeatDataPathResource', 'repeatDataPathTrailingResource', 'repeatDataBodyPut', 'repeatDataBodyPatch', 'getEnum', 'verifyEnum'];
    for (const methodName of complianceStubMethods) {
      const callPromise = this.complianceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 * @param {string} request.intendedBindingUri
 *   The URI template this request is expected to be bound to server-side.
 * @param {number} request.fInt32
 *   Some top level fields, to test that these are encoded correctly
 *   in query params.
 * @param {number} request.fInt64
 * @param {number} request.fDouble
 * @param {number} request.pInt32
 * @param {number} request.pInt64
 * @param {number} request.pDouble
 ...
 */
  repeatDataBody(
      request?: protos.google.showcase.v1beta1.IRepeatRequest,
      options?: CallOptions):
      Promise<[
  ...
  repeatDataBody(
      ...
      callback: Callback<
          protos.google.showcase.v1beta1.IRepeatResponse,
          protos.google.showcase.v1beta1.IRepeatRequest|null|undefined,
          {}|null|undefined>): void;
  repeatDataBody(
      request: protos.google.showcase.v1beta1.IRepeatRequest,
      callback: Callback<
  ...
  repeatDataBody(
    ...
    this.initialize();
    return this.innerApiCalls.repeatDataBody(request, options, callback);
  }
/**
 * This method echoes the ComplianceData request. This method exercises
 ...
 */
  ...
  repeatDataBodyInfo(
    ...
    options.otherArgs.headers = options.otherArgs.headers || {};
    this.initialize();
    return this.innerApiCalls.repeatDataBodyInfo(request, options, callback);
  }
/**
 * This method echoes the ComplianceData request. This method exercises
 ...
 */
  ...
  repeatDataQuery(
    ...
    options.otherArgs.headers = options.otherArgs.headers || {};
    this.initialize();
    return this.innerApiCalls.repeatDataQuery(request, options, callback);
  }
/**
 * This method echoes the ComplianceData request. This method exercises
 ...
 */
  ...
  repeatDataBodyPut(
    ...
    options.otherArgs.headers = options.otherArgs.headers || {};
    this.initialize();
    return this.innerApiCalls.repeatDataBodyPut(request, options, callback);
  }
/**
 ...
 */
  ...
  repeatDataBodyPatch(
    ...
    options.otherArgs.headers = options.otherArgs.headers || {};
    this.initialize();
    return this.innerApiCalls.repeatDataBodyPatch(request, options, callback);
  }
/**
 ...
 * @param {Object} request
 *   The request object that will be sent.
 * @param {boolean} request.unknownEnum
 ...
 */
  getEnum(
      request?: protos.google.showcase.v1beta1.IEnumRequest,
      options?: CallOptions):
      Promise<[
  ...
  getEnum(
      ...
      callback: Callback<
          protos.google.showcase.v1beta1.IEnumResponse,
          protos.google.showcase.v1beta1.IEnumRequest|null|undefined,
          {}|null|undefined>): void;
  getEnum(
      request: protos.google.showcase.v1beta1.IEnumRequest,
      callback: Callback<
  ...
  getEnum(
    ...
    options.otherArgs.headers = options.otherArgs.headers || {};
    this.initialize();
    return this.innerApiCalls.getEnum(request, options, callback);
  }
/**
 ...
 */
  ...
  verifyEnum(
      ...
      callback: Callback<
          protos.google.showcase.v1beta1.IEnumResponse,
          protos.google.showcase.v1beta1.IEnumResponse|null|undefined,
          {}|null|undefined>): void;
  verifyEnum(
      request: protos.google.showcase.v1beta1.IEnumResponse,
      callback: Callback<
  ...
  verifyEnum(
    ...
    options.otherArgs.headers = options.otherArgs.headers || {};
    this.initialize();
    return this.innerApiCalls.verifyEnum(request, options, callback);
  }
...
/**
   ...
   */
  close(): Promise<void> {
    if (this.complianceStub && !this._terminated) {
