...
function main() {
  // [START secretmanager_list_secret_versions_sample]
  /**
  ...
  async function listSecretVersions() {
    ...
    // Run request
    const iterable = await secretmanagerClient.listSecretVersions(request);
  ...
  listSecretVersions();
  // [END secretmanager_list_secret_versions_sample]
}
